...
**Goal:** Build three distributable open-source skills under `skills/` for modern Swift, Objective-C patterns, and modern UIKit, with routed `references/` content and starter eval prompts.
...
**Files:**
- Create: `skills/swift-modern/SKILL.md`
- Create: `skills/swift-modern/evals/evals.json`
- Create: `skills/objective-c-patterns/SKILL.md`
- Create: `skills/objective-c-patterns/evals/evals.json`
- Create: `skills/uikit-modern/SKILL.md`
- Create: `skills/uikit-modern/evals/evals.json`

- [ ] **Step 1: Create the directory tree**

Run:
```bash
mkdir -p skills/swift-modern/references/whats-new-swift
mkdir -p skills/swift-modern/evals
mkdir -p skills/objective-c-patterns/references
mkdir -p skills/objective-c-patterns/evals
mkdir -p skills/uikit-modern/references/ios-version-features
mkdir -p skills/uikit-modern/evals
```
...
`skills/objective-c-patterns/SKILL.md`
```md
---
...
`skills/swift-modern/evals/evals.json`
```json
{
...
`skills/objective-c-patterns/evals/evals.json`
```json
{
...
`skills/uikit-modern/evals/evals.json`
```json
{
...
Run:
```bash
rtk find skills -maxdepth 3 -type f | sort
```
...
**Files:**
- Modify: `skills/swift-modern/SKILL.md`
- Create: `skills/swift-modern/references/language-evolution-overview.md`
- Create: `skills/swift-modern/references/concurrency.md`
- Create: `skills/swift-modern/references/combine.md`
- Create: `skills/swift-modern/references/codable.md`
- Create: `skills/swift-modern/references/observation-and-state.md`
- Create: `skills/swift-modern/references/interoperability.md`
- Create: `skills/swift-modern/references/diagnostics.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-4.2.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.0.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.1.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.2.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.3.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.4.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.5.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.6.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.7.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.8.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.9.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-5.10.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-6.0.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-6.1.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-6.2.md`
- Create: `skills/swift-modern/references/whats-new-swift/swift-6.3.md`
...
Run:
```bash
rtk rg -n "^name: swift-modern$|^## When to Use$|^## Topic Router$|^## Correctness Checklist$" skills/swift-modern/SKILL.md
rtk find skills/swift-modern/references -type f | sort
rtk rg -n "Swift 4.2|Swift 5.5|Swift 6.0|Swift 6.3|Sendable|Codable|Combine" skills/swift-modern
```
...
**Files:**
- Modify: `skills/objective-c-patterns/SKILL.md`
- Create: `skills/objective-c-patterns/references/blocks-and-memory.md`
- Create: `skills/objective-c-patterns/references/runtime-and-swizzling.md`
- Create: `skills/objective-c-patterns/references/message-forwarding.md`
- Create: `skills/objective-c-patterns/references/kvc-kvo-and-associations.md`
- Create: `skills/objective-c-patterns/references/threading-and-gcd.md`
- Create: `skills/objective-c-patterns/references/objc-swift-interop.md`
- Create: `skills/objective-c-patterns/references/diagnostics.md`
...
Run:
```bash
rtk rg -n "^name: objective-c-patterns$|^## Topic Router$|^## Retain-Cycle Workflow$|^## Quick Diagnostics$" skills/objective-c-patterns/SKILL.md
rtk find skills/objective-c-patterns/references -type f | sort
rtk rg -n "block|retain cycle|swizzling|forwardInvocation|KVO|associated object|EXC_BAD_ACCESS" skills/objective-c-patterns
```
...
Run:
```bash
git add skills/objective-c-patterns
...
**Files:**
- Modify: `skills/uikit-modern/SKILL.md`
- Create: `skills/uikit-modern/references/collection-view-modernization.md`
- Create: `skills/uikit-modern/references/diffable-data-source.md`
- Create: `skills/uikit-modern/references/compositional-layout.md`
- Create: `skills/uikit-modern/references/list-configurations.md`
- Create: `skills/uikit-modern/references/keyboard-and-input.md`
- Create: `skills/uikit-modern/references/view-controller-lifecycle-and-scenes.md`
- Create: `skills/uikit-modern/references/navigation-and-presentation.md`
- Create: `skills/uikit-modern/references/diagnostics.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-13.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-14.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-15.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-16.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-17.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-18.md`
- Create: `skills/uikit-modern/references/ios-version-features/ios-26.md`
...
Run:
```bash
rtk rg -n "^name: uikit-modern$|^## Task Workflow$|^## Topic Router$|^## Modernization Checklist$" skills/uikit-modern/SKILL.md
rtk find skills/uikit-modern/references -type f | sort
rtk rg -n "UICollectionViewCompositionalLayout|NSDiffableDataSourceSnapshot|UICollectionViewDiffableDataSource|UIKeyboardLayoutGuide|UICollectionLayoutListConfiguration" skills/uikit-modern
```
...
Run:
```bash
rtk rg -n "^name: |^description: |^# |^## " skills/*/SKILL.md
rtk rg -n "TODO|TBD|FIXME|XXX" skills
```
...
Run:
```bash
rtk rg -n "references/" skills/*/SKILL.md
rtk find skills -type f | sort
```
